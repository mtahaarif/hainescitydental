...
<h1 className="text-4xl sm:text-5xl font-bold text-gray-900 mb-4">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          >
            {contactInfo.map((info, index) => (
              <motion.div
                ...
                className="glass-light p-8 transition-all duration-500 hover:shadow-[0_0_40px_rgba(59,130,246,0.25)]"
              >
                <motion.div
                  className="w-12 h-12 rounded-2xl bg-dental-blue-50 flex items-center justify-center mb-4"
          ...
          >
            <form
              ...
              className="glass-light p-8 space-y-6 transition-all duration-500 hover:shadow-[0_0_40px_rgba(59,130,246,0.25)]"
            >
              {isSubmitted ? (
                <motion.div
        ...
        <motion.div
          ...
          className="mt-12 glass-light rounded-3xl overflow-hidden border border-white/60 shadow-xl transition-all duration-500 hover:shadow-[0_0_40px_rgba(59,130,246,0.25)]"
        >
          <iframe
