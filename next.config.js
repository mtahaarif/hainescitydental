...
const nextConfig = {
  ...
  images: {
    ...
    remotePatterns: [
      ...
      // allow images served from the Headless WordPress backend (Hostgator)
      { protocol: 'http', hostname: 'admin.hainescitydental.com' },
      { protocol: 'https', hostname: 'admin.hainescitydental.com' },
    ],
